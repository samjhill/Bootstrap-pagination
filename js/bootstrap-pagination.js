...
$.prototype.extend(
	{
		'bootstrapPagination': function(userConfigurations) {
			var defaults = {
				rowsPerPage : 10,
				topNav : false
			};
			...
			return this.each(function() {
				...
				function createPaginationElements() {
					...
					paginationHTML += "<a id='tablePagination_firstPage' href='javascript:;' class='btn left '><i class='icon-large icon-double-angle-left'></i></a>";
					paginationHTML += "<a id='tablePagination_prevPage' href='javascript:;' style='margin-right: 1em;' class='btn right'><i class='icon-large icon-caret-left'></i></a>";
					paginationHTML += "Page";
					paginationHTML += "<input id='tablePagination_currPage' class='span1' style='margin-left: .5em;' type='input' value='" + currPageNumber + "' size='1'>";
					paginationHTML += " of " + totalPages + "&nbsp;&nbsp;&nbsp;";
					paginationHTML += "<a id='tablePagination_nextPage' href='javascript:;' class='btn left'><i class='icon-large icon-caret-right'></i></a>";
					paginationHTML += "<a id='tablePagination_lastPage' href='javascript:;' class='btn right'><i class='icon-large icon-double-angle-right '></i></a>";
					paginationHTML += "</div>";
